class User < ApplicationRecord
  ...
  validates :firstname, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥]/, message: "Firstname is invalid. Input full-width characters" }
  validates :lastname, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥]/, message: "Lastname is invalid. Input full-width characters" }
